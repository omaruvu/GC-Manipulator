Game.registerMod("GC Manipulator", {
	init: function () {
		...
		eval('Game.updateShimmers=' + Game.updateShimmers.toString().replace("newShimmer.spawnLead=1;", "newShimmer.spawnLead=1; if (i == 'golden') newShimmer.l.style.background = 'url('+Game.resPath+'img/SpawnleadGoldCookie.png'+')';"));
